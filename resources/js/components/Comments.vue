                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        <ul class="chat" id="chatWindow" style="height: 200px; overflow-y: scroll;">
                            <li v-for="comment in comments" :key="comment.id" class="left clearfix" style="list-style: none;">
                    ...
                    <form method="post" v-on:submit.prevent="submit" :action="add_comment_url">
                        <div class="panel-footer">
                            <div class="input-group">
                                <input type="text" v-model="comment" name="comment" class="form-control input-sm" placeholder="Escribe tu Mensjae...">
